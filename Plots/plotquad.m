...
set(gca,'XLim',[-2 40],'YLim',[-20 20],'ZLim',[0 20])
view(43,24)
%%%
%camproj perspctive 
camva(3)
...
plot3(out.pos_GV.Data(:,1),out.pos_GV.Data(:,2),out.pos_GV.Data(:,3),'LineWidth',0.5,'color','k')
xlabel('x')
ylabel('y')
zlabel('z')
...
[x,y,z]=rotateBFtoGF(carx,cary,carz,0,0,deg2rad(out.euler_GV.Data(S,3)));   
